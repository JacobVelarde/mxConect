...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		World.markerDrawable_idle = new AR.ImageResource("assets/logo2.png");
		World.markerDrawable_selected = new AR.ImageResource("assets/flechabien.png");
	...
	requestDataFromLocal: function requestDataFromLocalFn(centerPointLatitude, centerPointLongitude) {
		var poisToCreate = 6;
		var poiData = [];
		var latitud=[18.9176335, 18.9176645, 18.9187201,18.9218384,18.9217623,18.9200369];
		var longitud=[-99.2269624,-99.227597,-99.2275112,-99.2299272,-99.2386819,-99.2290688];
		for (var i = 0; i < poisToCreate; i++) {
			poiData.push({
				"id": (i + 1),
				"longitude": (longitud[i]),
				"latitude": (latitud[i]),
				"description": ("MxC"),
				"altitude": "100.0",
				"name": (" ")
