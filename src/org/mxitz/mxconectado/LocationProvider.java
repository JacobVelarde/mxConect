...
import org.mxitz.mxconectado.ArchitectViewHolderInterface.ILocationProvider;
	...
	public void onResume() {
		if ( this.locationManager != null && this.locationListener != null ) {
			...
			if ( !this.gpsProviderEnabled || !this.networkProviderEnabled ) {
				Toast.makeText( this.context, "Favor de activar su GPS y red Wi-Fi ", Toast.LENGTH_LONG ).show();
			}
		}
	}
}
